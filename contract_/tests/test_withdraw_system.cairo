...
use snforge_std::{
    ...
    start_cheat_block_number, stop_cheat_block_number, get_class_hash, spy_events,
    EventSpyAssertionsTrait, EventSpy
};
use starknet::{ContractAddress, contract_address_const, get_block_timestamp};
use contract_::BigIncGenesis::{
    IBigIncGenesisDispatcher, IBigIncGenesisDispatcherTrait, WithdrawalRequest, VoteStatus
};
...
fn test_submit_withdrawal_request_insufficient_balance() {
    ...
    contract.submit_withdrawal_request(
        usdt_address,
        amount,
        deadline,
        milestone_uri
